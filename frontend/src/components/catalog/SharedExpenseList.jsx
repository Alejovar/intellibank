  ...
  return (
    <div className="card">
      ...
      <div style={{ display: "flex", flexDirection: "column", marginTop: 8 }}>
        {people.map((p, i) => (
          <div key={i} style={{ display: "flex", justifyContent: "space-between", padding: "10px 0", borderBottom: i < people.length - 1 ? "1px solid #F4ECEE" : 0, fontSize: 13.5 }}>
            <span style={{ fontWeight: 700 }}>{p.name}</span>
            <span style={{ color: p.owes - p.paid > 0 ? "var(--red-500)" : "var(--ok-600)", fontWeight: 800 }}>
