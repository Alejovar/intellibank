...
const CATEGORIES = [
  ...
  { id: "inversiones", label: "Inversiones", hint: "Liquidez, instrumentos, mercados y metas", tint: "#EEF3FC", subtemas: ["Perfilamiento", "Liquidez", "Portafolios", "Simulación", "Renta fija", "Deuda", "Renta variable", "Fondos", "Mercado", "Divisas", "Notas estructuradas", "Metas"] },
